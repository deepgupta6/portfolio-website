...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project4,
    description:
      "The product store website enables users to add, view, and delete products with images, descriptions, and prices. It offers an easy-to-use interface for efficient product management and inventory updates..",
